 ...
 */
public class MainPrism4DProjectsListFragment extends Fragment {
    ...
    public static MainPrism4DProjectsListFragment newInstance(Prism4DPath projectPath) {

        Bundle args = new Bundle();
        Prism4DPath.putPathInArguments(args, projectPath);

        MainPrism4DProjectsListFragment fragment = new MainPrism4DProjectsListFragment();
    ...
    //Constructor
    public MainPrism4DProjectsListFragment() {
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private MainPrism4DProjectsListFragment.ClickListener clickListener;

        RecyclerTouchListener(Context context,
                                     final RecyclerView recyclerView,
                                     final MainPrism4DProjectsListFragment.ClickListener
                                             clickListener) {
