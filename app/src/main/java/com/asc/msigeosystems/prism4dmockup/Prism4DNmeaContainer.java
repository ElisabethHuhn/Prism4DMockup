 ...
 */
public class Prism4DNmeaContainer {

    private static List<Prism4DNmea> sNmeaList;

    private static Prism4DNmeaContainer ourInstance ;

    public static Prism4DNmeaContainer getInstance() {
        if (ourInstance == null){
            ourInstance = new Prism4DNmeaContainer();
        }
        return ourInstance;
    }
